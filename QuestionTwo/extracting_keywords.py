...
if response.status_code == 200:
    ...
    for document in json_response.get('result', []):
        ...
        keywords = [kw for kw in keywords if kw not in (None, 'zbMATH Open Web Interface contents unavailable due to conflicting licenses.')] 
        all_keywords.extend(keywords)  # Extend the list of keywords
